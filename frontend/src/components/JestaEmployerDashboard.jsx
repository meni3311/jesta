...
const APPLICANTS = [
  { id: "w-1", name: "יובל כהן",   role: "עוזר בדוכן פופקורן", rating: 4.9, emoji: "🧑", badge: "מומלץ" },
  { id: "w-2", name: "תמר לוי",    role: "עוזר בדוכן פופקורן", rating: 4.7, emoji: "👩", badge: null },
  { id: "w-3", name: "אריאל גולן", role: "עוזר בדוכן פופקורן", rating: 4.5, emoji: "👦", badge: null },
];
...
function ApplicantCard({ applicant, isApproved, onApprove, onOpenProfile, onOpenChat }) {
  return (
    <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}
      transition={{ type: "spring", stiffness: 300, damping: 28 }}
      style={{ background: "#fff", borderRadius: 18, border: "1px solid #ede9fe",
        boxShadow: "0 2px 8px rgba(124,58,237,0.06)", padding: "14px", marginBottom: 10 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 2 }}>
            ...
            {applicant.badge && (
              <span style={{ fontSize: 10, fontWeight: 700, color: GOLD, background: "#fef3c7",
                border: "1px solid #fde68a", borderRadius: 10, padding: "1px 7px" }}>
                {applicant.badge}
              </span>
            )}
          </div>
          <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
            ...
            <span style={{ fontSize: 11, color: MUTED, fontWeight: 600, marginRight: 2 }}>
              {applicant.rating}
            </span>
          </div>
        </div>
        ...
        {isApproved ? (
          <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 4, background: "#f0fdf4",
              border: "1px solid #bbf7d0", borderRadius: 20, padding: "6px 12px" }}>
...
export default function JestaEmployerDashboard({
  onBack, onOpenCreate, onApproveWorker, approvedWorkerIds, onOpenProfile, onOpenChat
}) {
  return (
    <div dir="rtl" style={{ fontFamily: "'Heebo','Segoe UI',system-ui,sans-serif",
      ...
      <div style={{ background: "#fff", padding: "48px 18px 16px",
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              <div style={{ fontSize: 20, fontWeight: 900, color: SLATE }}>
                דאשבורד מעסיק 📊
              </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "16px 14px 24px" }}>
        ...
        {ACTIVE_JOBS.map((job) => (
          <div key={job.id} style={{ background: "#fff", borderRadius: 16,
            border: "1px solid #ede9fe", padding: "13px 14px", marginBottom: 10,
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: 12, marginTop: 4 }}>
                <span style={{ fontSize: 11.5, color: MUTED, fontWeight: 500 }}>
                  <Clock size={10} color="#c4b5fd"
                    style={{ display: "inline", marginLeft: 3 }} />{job.time}
                </span>
              </div>
            </div>
